...
export const commercialPlanes: Aircraft[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Cruise speed", value: "Mach 0.85 (567 mph / 903 km/h)" },
      { label: "Range", value: "8,100 nmi (15,000 km) — A350-900 · 8,700 nmi (16,100 km) — A350-1000 · ~10,000 nmi — A350-1000ULR" },
      { label: "Passengers", value: "300–350 (3-class) — A350-900 · 350–410 (3-class) — A350-1000 · 238 (4-class) — A350-1000ULR" },
      { label: "Max takeoff weight", value: "617,300 lb (280,000 kg) — A350-900; increased on -1000ULR for extra fuel" },
      { label: "Composite content", value: "53% by weight (more than any other airliner)" },
      { label: "Variants", value: "A350-900 · A350-1000 · A350-1000ULR · A350F freighter" },
