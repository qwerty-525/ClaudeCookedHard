...
function frameUrl(index: number) {
  return `/sequence_f35stagelight/ezgif-frame-${String(index + 1).padStart(3, "0")}.png`
}

export default function F35Scroll() {
        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white/90 leading-none drop-shadow-[0_0_60px_rgba(239,68,68,0.2)]">
              F-35 Lightning II.
              <br />
              <span className="text-white/50">Born to Dominate.</span>
            </h1>
            <p className="mt-6 text-white/50 text-base md:text-lg max-w-md leading-relaxed">
              The most advanced multi-role combat aircraft ever built.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-4 text-white/50 text-sm md:text-base max-w-sm leading-relaxed">
              Every surface angled and coated to absorb radar energy.
              A radar cross-section the size of a metal golf ball.
            </p>
          </motion.div>
          ...
          >
            <div className="text-right max-w-lg">
              ...
              <p className="mt-4 text-white/50 text-sm md:text-base max-w-sm leading-relaxed ml-auto">
                Six infrared cameras fused into a 360° sphere.
                The pilot sees through the aircraft's own skin.
              </p>
            </div>
          </motion.div>
