  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&[data-state=open]>svg]:rotate-180 [&[data-state=open]]:text-amber-400",
        className,
      )}
      {...props}
    >
      {children}
      <ChevronDown className="h-4 w-4 shrink-0 text-[#94a3b8] transition-transform duration-300 [&[data-state=open]]:text-amber-400" />
    </AccordionPrimitive.Trigger>
